...
export class AntecedentesController {
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint retorna todos los antecedentes existentes en la base de datos.',
  })
  @ApiQuery({
    name: 'filter',
    type: String,
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint sirve para crear nuevos antecedentes en la base de datos.',
  })
  @ApiBody({
    description:
      'Ejemplo para crear un antecedente, el unico dato necesario es el id de un Paciente del sexo femeninio',
    schema: {
      type: 'object',
      properties: {
        pacienteId: {
  ...
  @ApiResponse({
    status: 400,
    description:
      'Solicitud incorrecta. Puede ser que el paciente no se haya encontrado.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint sirve para actualizar los datos de un antecedente existente.',
  })
  @ApiParam({
    name: 'id',
    type: String,
