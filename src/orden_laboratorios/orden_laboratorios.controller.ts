...
export class OrdenLaboratoriosController {
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint sirve para crear una nueva orden de laboratorio',
  })
  @ApiResponse({
    status: 201,
  ...
  create(@Body() createOrdenLaboratorioDto: CreateOrdenLaboratorioDto) {
    return this.ordenLaboratorioService.createByExams(
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint devuelve todas las órdenes de laboratorio, con filtros y paginación opcionales.',
  })
  @ApiQuery({
    name: 'q',
    type: String,
          ...
          items: {
            ...
            properties: {
              ...
              retiro: {
                type: 'object',
                nullable: true,
                properties: { id: { type: 'string' }, fecha: { type: 'date' } },
              },
              is_active: { type: 'boolean', example: true },
            },
          },
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint devuelve una única orden de laboratorio basada en su ID.',
  })
  @ApiParam({
    name: 'id',
    type: 'string',
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint sirve para actualizar los datos de una orden de laboratorio existente.',
  })
  @ApiParam({
    name: 'id',
    type: 'string',
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint elimina una orden de laboratorio de manera lógica, es decir, no la borra físicamente sino que la desactiva.',
  })
  @ApiParam({
    name: 'id',
    type: 'string',
  ...
  @ApiOperation({
    summary:
      'Crear una nueva orden de laboratorio en funcion de un examen predeterminado',
    description:
      'Este endpoint sirve para crear una nueva orden de laboratorio',
  })
  @ApiResponse({
