...
<<<<<<<< HEAD:src/migrations/1727639923552-database_adquisiciones_y_detalle.ts
...
========
export class DatabaseAdquisicionesYDetalle1727598500130 implements MigrationInterface {
    name = 'DatabaseAdquisicionesYDetalle1727598500130'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "adquisicion" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "descripcion" character varying(255) NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "usuarioId" uuid, CONSTRAINT "PK_15342430f096791d119ee14c845" PRIMARY KEY ("id"))`);
>>>>>>>> 9e5ce19 (Se corrigio el error y se cambio unicamente la ruta de crear y actualizar el dto de detalle adquisicion):src/migrations/1727598500130-database_adquisiciones_y_detalle.ts
