...
export class DatabaseAdquisicionesYDetalle1727591128068 implements MigrationInterface {
    name = 'DatabaseAdquisicionesYDetalle1727591128068'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "detalleAdquisicion" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "is_active" boolean NOT NULL DEFAULT true, "cantidad" boolean NOT NULL DEFAULT true, "adquisicionId" uuid, "insumoDepartamentoId" uuid, CONSTRAINT "PK_b8627cd94a0691d1e3614add7c2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "adquisicion" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" character varying(12) NOT NULL, "descripcion" character varying(255) NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "usuarioId" uuid, CONSTRAINT "PK_15342430f096791d119ee14c845" PRIMARY KEY ("id"))`);
