...
export class LotesController {
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint sirve para buscar un lote por su ID, si está activo',
  })
  @ApiParam({
    name: 'id',
    type: 'string',
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint sirve para eliminar un lote sin borrarlo físicamente de la base de datos',
  })
  @ApiParam({
    name: 'id',
    type: 'string',
